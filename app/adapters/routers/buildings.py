...
from app.adapters.schemas.building import BuildingSchema, BuildingCreateSchema, BuildingUpdateSchema
...
@inject
async def update(building_id: int, building: BuildingUpdateSchema, service: FromDishka[BuildingService]):
