...
from app.domain.entities import Activity, Base, Building, Organization, OrganizationActivity
...
async def seed_data():
    ...
    async with AsyncSessionLocal() as session:
        async with session.begin():
            ...
            building1 = Building(address='ул. Ленина, 1', latitude=55.7558, longitude=37.6173)
            building2 = Building(address='ул. Мира, 10', latitude=55.7580, longitude=37.6200)
            ...
            organization = Organization(
                name='ООО Рога и Копыта', phones=['+79991234567'], building_id=building1.id
            )
